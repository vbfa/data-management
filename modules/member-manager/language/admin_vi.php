...
$lang_module['editreason'] = 'Nguyên nhân sửa';
...
$lang_module['report_field_learningtasks'] = 'Nhiệm vụ học tập';
$lang_module['report_field_address'] = 'Địa chỉ';
$lang_module['report_field_fb_twitter'] = 'FB/Twitter';
$lang_module['report_field_contactsocial'] = 'Zalo/Messenger/Viber';
...
$lang_module['queue_accept_confirm'] = 'Bạn có chắc chắn duyệt thông tin thay đổi của hội viên này không? Khi duyệt nhanh thì toàn bộ thông tin cũ sẽ được cập nhật bằng thông tin mới bất kết hội viên có nhập hay bỏ trống!';
...
$lang_module['queue_error_studytime'] = 'Lỗi: Thời gian học nhập không hợp lệ';
